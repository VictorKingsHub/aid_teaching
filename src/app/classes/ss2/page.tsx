...
interface SS2PageProps {}

const SS2Page: React.FC<SS2PageProps> = () => {
  const ss2Subjects: string[] = [
    ...
    <div className="min-h-screen md:min-h-screen p-4 text-center bg-gray-50">
      ...
      <div className="mt-12">
        ...
        <p className="text-gray-700 mb-6">
          Here are some extra resources to help you with your SS2 studies:
        </p>
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">About SS2</h2>
        <p className="text-gray-700 max-w-2xl mx-auto">
          Senior Secondary School 2 (SS2) is a crucial year in secondary education. Here's an overview of what you'll learn.
        </p>
      </div>
      ...
      <div className="flex justify-around mt-8">
        ...
        <Link href="/classes/ss3" className="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors">
          Next
        </Link>
      </div>
    </div>
