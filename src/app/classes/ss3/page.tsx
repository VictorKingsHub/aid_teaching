...
interface SS3PageProps {}

const SS3Page: React.FC<SS3PageProps> = () => {
  const ss3Subjects: string[] = [
    ...
    <div className="min-h-screen md:min-h-screen p-4 text-center bg-gray-50">
      ...
      <div className="mt-12">
        ...
        <p className="text-gray-700 mb-6">
          Here are some extra resources to help you with your SS3 studies:
        </p>
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">About SS3</h2>
        <p className="text-gray-700 max-w-2xl mx-auto">
          Senior Secondary School 3 (SS3) is the final year of senior secondary education.  It is a very important year.
        </p>
      </div>
